...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'fastxtend.audio.all': {},
            ...
            'fastxtend.optimizer.adan': { 'fastxtend.optimizer.adan.Adan': ('optimizer.adan.html#adan', 'fastxtend/optimizer/adan.py'),
                                          ...
                                          'fastxtend.optimizer.adan.adan_avgs': ( 'optimizer.adan.html#adan_avgs',
                                                                                  'fastxtend/optimizer/adan.py'),
            ...
            'fastxtend.optimizer.foreach': { 'fastxtend.optimizer.foreach.AdamForEachOptimizer': ( 'optimizer.foreach.html#adamforeachoptimizer',
                                             ...
                                             'fastxtend.optimizer.foreach.RAdamForEachOptimizer.step': ( 'optimizer.foreach.html#radamforeachoptimizer.step',
                                                                                                         'fastxtend/optimizer/foreach.py'),
                                             'fastxtend.optimizer.foreach.RangerOptimizer': ( 'optimizer.foreach.html#rangeroptimizer',
                                                                                              'fastxtend/optimizer/foreach.py'),
                                             'fastxtend.optimizer.foreach.RangerOptimizer.__init__': ( 'optimizer.foreach.html#rangeroptimizer.__init__',
                                                                                                       'fastxtend/optimizer/foreach.py'),
                                             'fastxtend.optimizer.foreach.RangerOptimizer._init_state': ( 'optimizer.foreach.html#rangeroptimizer._init_state',
                                                                                                          'fastxtend/optimizer/foreach.py'),
                                             'fastxtend.optimizer.foreach.RangerOptimizer.clear_state': ( 'optimizer.foreach.html#rangeroptimizer.clear_state',
                                                                                                          'fastxtend/optimizer/foreach.py'),
                                             'fastxtend.optimizer.foreach.RangerOptimizer.load_state_dict': ( 'optimizer.foreach.html#rangeroptimizer.load_state_dict',
                                                                                                              'fastxtend/optimizer/foreach.py'),
                                             'fastxtend.optimizer.foreach.RangerOptimizer.state_dict': ( 'optimizer.foreach.html#rangeroptimizer.state_dict',
                                                                                                         'fastxtend/optimizer/foreach.py'),
                                             'fastxtend.optimizer.foreach.RangerOptimizer.step': ( 'optimizer.foreach.html#rangeroptimizer.step',
                                                                                                   'fastxtend/optimizer/foreach.py'),
                                             ...
                                             'fastxtend.optimizer.foreach.sgd_foreach_step': ( 'optimizer.foreach.html#sgd_foreach_step',
                                                                                               'fastxtend/optimizer/foreach.py')},
            'fastxtend.optimizer.torchscript': { 'fastxtend.optimizer.torchscript.Adam': ( 'optimizer.torchscript.html#adam',
                                                                                           'fastxtend/optimizer/torchscript.py'),
                                                 'fastxtend.optimizer.torchscript.JitLookahead': ( 'optimizer.torchscript.html#jitlookahead',
                                                                                                   'fastxtend/optimizer/torchscript.py'),
                                                 ...
                                                 'fastxtend.optimizer.torchscript.JitOptimizer.step': ( 'optimizer.torchscript.html#jitoptimizer.step',
                                                                                                        'fastxtend/optimizer/torchscript.py'),
                                                 'fastxtend.optimizer.torchscript.Lamb': ( 'optimizer.torchscript.html#lamb',
                                                                                           'fastxtend/optimizer/torchscript.py'),
                                                 'fastxtend.optimizer.torchscript.Larc': ( 'optimizer.torchscript.html#larc',
                                                                                           'fastxtend/optimizer/torchscript.py'),
                                                 'fastxtend.optimizer.torchscript.QHAdam': ( 'optimizer.torchscript.html#qhadam',
                                                                                             'fastxtend/optimizer/torchscript.py'),
                                                 'fastxtend.optimizer.torchscript.RAdam': ( 'optimizer.torchscript.html#radam',
                                                                                            'fastxtend/optimizer/torchscript.py'),
                                                 'fastxtend.optimizer.torchscript.RMSProp': ( 'optimizer.torchscript.html#rmsprop',
                                                                                              'fastxtend/optimizer/torchscript.py'),
                                                 'fastxtend.optimizer.torchscript.SGD': ( 'optimizer.torchscript.html#sgd',
                                                                                          'fastxtend/optimizer/torchscript.py'),
                                                 ...
                                                 'fastxtend.optimizer.torchscript.adam_jit_step': ( 'optimizer.torchscript.html#adam_jit_step',
                                                                                                    'fastxtend/optimizer/torchscript.py'),
                                                 'fastxtend.optimizer.torchscript.debias': ( 'optimizer.torchscript.html#debias',
                                                                                             'fastxtend/optimizer/torchscript.py'),
                                                 ...
                                                 'fastxtend.optimizer.torchscript.radam_jit_step': ( 'optimizer.torchscript.html#radam_jit_step',
                                                                                                     'fastxtend/optimizer/torchscript.py'),
                                                 'fastxtend.optimizer.torchscript.ranger': ( 'optimizer.torchscript.html#ranger',
                                                                                             'fastxtend/optimizer/torchscript.py'),
