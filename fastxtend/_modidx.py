...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'fastxtend.audio.all': {},
            ...
            'fastxtend.optimizer': { 'fastxtend.optimizer.Adam': ('optimizer.html#adam', 'fastxtend/optimizer.py'),
                                     'fastxtend.optimizer.Lamb': ('optimizer.html#lamb', 'fastxtend/optimizer.py'),
                                     'fastxtend.optimizer.Larc': ('optimizer.html#larc', 'fastxtend/optimizer.py'),
                                     'fastxtend.optimizer.QHAdam': ('optimizer.html#qhadam', 'fastxtend/optimizer.py'),
                                     'fastxtend.optimizer.RAdam': ('optimizer.html#radam', 'fastxtend/optimizer.py'),
                                     'fastxtend.optimizer.RMSProp': ('optimizer.html#rmsprop', 'fastxtend/optimizer.py'),
                                     'fastxtend.optimizer.Ranger': ('optimizer.html#ranger', 'fastxtend/optimizer.py'),
                                     'fastxtend.optimizer.SGD': ('optimizer.html#sgd', 'fastxtend/optimizer.py'),
                                     'fastxtend.optimizer.adam': ('optimizer.html#adam', 'fastxtend/optimizer.py'),
                                     'fastxtend.optimizer.lamb': ('optimizer.html#lamb', 'fastxtend/optimizer.py'),
                                     'fastxtend.optimizer.larc': ('optimizer.html#larc', 'fastxtend/optimizer.py'),
                                     'fastxtend.optimizer.qhadam': ('optimizer.html#qhadam', 'fastxtend/optimizer.py'),
                                     'fastxtend.optimizer.radam': ('optimizer.html#radam', 'fastxtend/optimizer.py'),
