...
index = {"is_listish": "0_basics.ipynb",
         ...
         "ClassBalanced": "loss.classbalanced.ipynb",
         "ClassBalancedCrossEntropyLoss": "loss.classbalanced.ipynb",
         "ClassBalancedBCEWithLogitsLoss": "loss.classbalanced.ipynb",
