...
index = {"is_listish": "0_basics.ipynb",
         ...
         "BCEWithLogitsLoss": "losses.ipynb",
         ...
         "avg_grad": "optimizers.adan.ipynb",
         "avg_grad.defaults": "optimizers.adan.ipynb",
         "step_stat": "optimizers.adan.ipynb",
         "avg_diff_grad": "optimizers.adan.ipynb",
         "avg_diff_grad.defaults": "optimizers.adan.ipynb",
         "avg_nesterov_est": "optimizers.adan.ipynb",
         "avg_nesterov_est.defaults": "optimizers.adan.ipynb",
         "prior_grad": "optimizers.adan.ipynb",
         "adan_step": "optimizers.adan.ipynb",
         "Adan": "optimizers.adan.ipynb",
         "AdanLargeBatchLR": "optimizers.adan.ipynb",
         "FineTuneOpt": "optimizers.finetune.ipynb",
         "fine_tune_wd": "optimizers.finetune.ipynb",
         "SGDFT": "optimizers.finetune.ipynb",
         "RMSPropFT": "optimizers.finetune.ipynb",
         "AdamFT": "optimizers.finetune.ipynb",
         "RAdamFT": "optimizers.finetune.ipynb",
         "QHAdamFT": "optimizers.finetune.ipynb",
         "LarcFT": "optimizers.finetune.ipynb",
         "LambFT": "optimizers.finetune.ipynb",
         "LookaheadFT": "optimizers.finetune.ipynb",
         "rangerFT": "optimizers.finetune.ipynb",
