...
# %% ../../nbs/audio.03_augment.ipynb 1
# Contains code from:
# fastai - Apache License 2.0 - Copyright (c) 2023 fast.ai

# %% ../../nbs/audio.03_augment.ipynb 3
...
from fasttransform import DisplayedTransform, retain_type, retain_meta
...
# Noise contains code from https://github.com/fastaudio/fastaudio:
...
# PitchShift & TimeStretch contains code from https://github.com/KentoNishi/torch-pitch-shift & https://github.com/KentoNishi/torch-time-stretch
# torch-pitch-shift & torch-time-stretch - MIT License - Copyright (c) 2021 Kento Nishi
...
def pitch_shift(x:TensorAudio, n_fft, hop_length, shift, sr, new_sr, gcd, kernel, width, padmode, constant, device):
    ...
    window = None
    x = retain_meta(_apply_sinc_resample_kernel(x, sr, new_sr, gcd, kernel, width), x)
